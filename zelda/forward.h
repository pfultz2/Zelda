...
// ZELDA_FORWARD_FUNCTION macro
#define ZELDA_FORWARD_FUNCTION(n, T, x) BOOST_PP_ENUM(n, ZELDA_DETAIL_FORWARD_FUNCTION_OP, (T, x))
#define ZELDA_FORWARD_FUNCTION_Z(z, n, T, x) BOOST_PP_ENUM_ ## z(n, ZELDA_DETAIL_FORWARD_FUNCTION_OP, (T, x))
#define ZELDA_DETAIL_FORWARD_FUNCTION_OP(z, n, data) zelda::forward<BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 0, data), n)>(BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 1, data), n))
