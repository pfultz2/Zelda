...
#define DETAIL_ZELDA_FOREACH_PROCESS_AUTO_INVOKE_M(d, state) DETAIL_ZELDA_FOREACH_PROCESS_AUTO_M state
#else
...
#define DETAIL_ZELDA_FOREACH_PROCESS_AUTO_INVOKE_M(d, state) ZELDA_PP_MSVC_INVOKE(DETAIL_ZELDA_FOREACH_PROCESS_AUTO_M, state)
#endif
...
#define DETAIL_ZELDA_FOREACH_PROCESS_AUTO_OP_AUTO(head, tail, col, x, key) (head typeof((*boost::begin(col))) key, BOOST_PP_SEQ_TAIL(x), col, ZELDA_PP_FALSE())
