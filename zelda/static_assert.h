...
#define ZELDA_STATIC_ASSERT(...) ZELDA_DETAIL_STATIC_ASSERT_SEQ(ZELDA_PP_ARGS_TO_SEQ(__VA_ARGS__))

#ifndef ZELDA_USE_STATIC_ASSERT_KEYWORD
#define ZELDA_USE_STATIC_ASSERT_KEYWORD 1
#if ZELDA_USE_STATIC_ASSERT_KEYWORD
#define static_assert ZELDA_STATIC_ASSERT
#endif

#else
#define ZELDA_STATIC_ASSERT static_assert
#endif
